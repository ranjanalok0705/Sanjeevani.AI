...
# Create TF-IDF Vectorizer for the 'Disaster Categories' column
vectorizer = TfidfVectorizer(stop_words='english')

# Fit and transform the disaster categories to get the TF-IDF matrix
...
user_input = "Flood sdfsfsfsfs earthquake"
