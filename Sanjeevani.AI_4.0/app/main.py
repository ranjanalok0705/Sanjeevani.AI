...
# Filter NGOs by selected city
    ...
    return templates.TemplateResponse(
        "filter.html",  
        {"request": request,  "city": city, "user_input": user_input, "ngos": filtered_ngos.to_dict(orient="records")}
    )
...
async def send_notification(background_tasks: BackgroundTasks, request: Request, notification: dict):
    ...
    **User Location Details**  
    ...
    - **City:** {city}
    - **Latitude:** {ip_location.get('latitude', 'N/A')}
    - **Longitude:** {ip_location.get('longitude', 'N/A')}
    - **ISP:** {ip_location.get('isp', 'N/A')}
